const BASE = 'https://github.com/zhengyangyang2017/zy/releases/latest/download'
...
const PLATFORMS = [
  {
    ...
    href: `${BASE}/Claude-Code-GUI-1.0.0-win-x64.exe`,
  },
  {
    icon: '🍎',
    name: 'macOS',
    ext: '.dmg',
    desc: 'macOS 12+ (Intel)',
    href: `${BASE}/Claude-Code-GUI-1.0.0-mac-x64.dmg`,
  },
  {
    icon: '🍎',
    name: 'macOS Silicon',
    ext: '.dmg',
    desc: 'macOS 12+ (Apple M1/M2/M3)',
    href: `${BASE}/Claude-Code-GUI-1.0.0-mac-arm64.dmg`,
  },
  {
    icon: '🐧',
    name: 'Linux',
    ...
    href: `${BASE}/Claude-Code-GUI-1.0.0-linux-x64.AppImage`,
  },
]
